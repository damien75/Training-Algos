class DuplicateLetters(object):
    """
    Input : string s of length n

    Goal: Remove duplicate letters from s and return smallest lexicographical solution without reordering s

    Idea: use a stack to add the letters, and keep track of the nb of letters we will still see after our current
    position
    ...
    @staticmethod
    def remove_duplicate_letters_from(s: str) -> str:
